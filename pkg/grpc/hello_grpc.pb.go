...
const (
	GreetingService_Hello_FullMethodName             = "/grpc_tutorial.GreetingService/Hello"
	GreetingService_HelloServerStream_FullMethodName = "/grpc_tutorial.GreetingService/HelloServerStream"
)
...
var GreetingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpc_tutorial.GreetingService",
